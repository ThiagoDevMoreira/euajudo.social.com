// fixture para teste de integração postgres-dbcontext-models
...
public class PostgresTestDatabaseFixture : IAsyncLifetime
{
    ...
    public PostgresTestDatabaseFixture()
    {
        ...
        _conn = "Host=localhost;Username=postgres;Password=123;Database=postgres";
    ...
    public EuAjudoDbContext CreateContext()
    {
        var options = new DbContextOptionsBuilder<EuAjudoDbContext>()
            .UseNpgsql(ConnectionString)
            .Options;
